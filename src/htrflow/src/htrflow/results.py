...
class Result:
    ...
    @classmethod
    def word_segmentation_result(cls, words, line=None, line_score=None, word_scores=None, token_scores=None, **segments):
        result = cls.segmentation_result(**segments)
        if line:
            line_score = line_score or 0
            result.data = {TEXT_RESULT_KEY: RecognizedText(line, line_score), "token_scores": token_scores}
